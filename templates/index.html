        ...
        <div class="row align-items-stretch">
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-4" data-aos="fade-up">
            ...
            <div class="unit-4 d-block">
              ...
              <div>
                ...
                <p>If you're shifting away from your work, the colour slowly changes, helping you notice that you're not as much productive.</p>
          ...
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-4" data-aos="fade-up">
            ...
            <div class="unit-4 d-block">
              ...
              <div>
                ...
                <p>The product is unique in its implementation and can be used to boost efficiency.</p>
                <!-- <p><a href="#">Learn More</a></p> -->
              </div>
            </div>
          </div>
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-4" data-aos="fade-up" >
            <div class="unit-4 d-block">
              ...
              <div>
                <h3>User Privacy</h3>
                <p>We respect our users privacy, so the data remains local on your pc and raspberry pi.</p>
                <!-- <p><a href="#">Learn More</a></p> -->
              </div>
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-4" data-aos="fade-up">
            <div class="unit-4 d-block">
              ...
              <div>
                ...
                <p>You can set an exclusion list of programs and websites which you use in order to improve analytics and calculations.</p>
                <!-- <p><a href="#">Learn More</a></p> -->
              </div>
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-4" data-aos="fade-up">
            <div class="unit-4 d-block">
              ...
              <div>
                ...
                <p>You can look back at the analytics on how productive you were, by looking at the points where you were unproductive, the user can get a better understanding and make better time management.</p>
                <!-- <p><a href="#">Learn More</a></p> -->
              </div>
            </div>
          ...
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-4" data-aos="fade-up">
            <div class="unit-4 d-block">
              ...
              <div>
                <h3>Plug &amp; Play</h3>
                <p>Just as simple as plug and play, plug your rasberry pi connected with LEDs and setup on the prompted page.</p>
                <!-- <p><a href="#">Learn More</a></p> -->
              </div>
            </div>
          </div>
      ...
      <div class="container">
        <div class="row mb-5 site-section border-bottom">
          ...
          <div class="col-lg-5 pl-lg-5 ml-auto mt-md-5">
            <h2 class="text-black">Get Productive</h2>
            <p class="mb-4">Time is money, so by managing time the right way you work more efficient, getting over with your work faster and easier</p>
